"""
Опциональное дообучение rubert-tiny2.
Запускать только после подготовки ручной разметки data/labels/labeled_fragments.xlsx.

Установка дополнительных зависимостей:
pip install torch transformers datasets accelerate

Этот скрипт не входит в основной pipeline, потому что требует больше ресурсов.
"""
